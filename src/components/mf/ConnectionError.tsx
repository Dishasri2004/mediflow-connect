...
export function ConnectionError({ onRetry }: { onRetry: () => void }) {
  return (
    <div
      role="alert"
      className="rounded-lg border-2 border-destructive bg-destructive-soft p-5"
    >
      <div className="flex items-start gap-3">
        <WifiOff aria-hidden="true" className="mt-0.5 size-5 shrink-0 text-destructive" />
        <div className="min-w-0">
          <h2 className="text-h2 text-destructive">Your connection was interrupted.</h2>
          <p className="mt-1 text-small">Your information is still here. Nothing was lost.</p>
